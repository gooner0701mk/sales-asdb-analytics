...
export function TargetsTab({
  ...
  /** 一覧をカード表示（スマホ・iPad 向け。日付列と経過列の重なりを防ぐ） */
  const targetsCardLayout = useMediaQuery('(max-width: 1024px)')
  ...
  return (
    <div className="targets-tab">
      ...
      <section className="panel">
        ...
        {narrowLayout ? (
          <details className="mobile-input-drawer mobile-input-drawer--in-panel" open>
      ...
      <section className="panel targets-table-panel">
        {targetsCardLayout ? (
          <div className="targets-card-list" role="list">
            {visible.length === 0 ? (
              <p className="targets-empty targets-empty--card">
                {targets.length === 0
              ...
              visible.map((t) => {
                ...
                return (
                  <div
                    key={t.id}
                    className="targets-row-card"
                    role="listitem"
                  >
                    <div className="targets-row-card-grid">
                      <label className="targets-row-card-field targets-row-card-field--company">
                        <span className="field-label">企業名</span>
                        <input
                          type="text"
                          className="cell-input targets-row-card-input-wide"
                          value={t.companyName}
                          onChange={(e) =>
                      ...
                      <div className="targets-row-card-field">
                        <span className="field-label">流入経路（ログ）</span>
                      ...
                      {showOwnerCol && (
                        <label className="targets-row-card-field">
                    ...
                    <div className="targets-row-card-datetime">
                      <label className="targets-row-card-field targets-row-card-field--date">
                        <span className="field-label">前回アプローチ日</span>
                        <input
                          type="date"
                          className="cell-input targets-row-card-date-input"
                      ...
                      <div className="targets-row-card-field targets-row-card-field--elapsed">
                        <span className="field-label">経過</span>
                        <div className="targets-elapsed targets-elapsed--card">
                          {elapsed === null ? (
                            <span className="muted">―</span>
                          ) : (
                            <span
                    ...
                    <div className="targets-row-card-actions">
                      <button
                        type="button"
                        className="btn small"
