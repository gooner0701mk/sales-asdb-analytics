/** SHA-256?crypto.subtle ?????????????LAN ?? HTTP ??? */
...
function sha256Sync(bytes: Uint8Array): Uint8Array {
  const K = new Uint32Array([
    ...
    0x983e5152, 0xa831c66d, 0xb00327c8, 0xbf597fc7, 0xc6e00bf5, 0xd5a79147,
...
export async function sha256Hex(data: Uint8Array): Promise<string> {
  if (typeof crypto !== 'undefined' && crypto.subtle?.digest) {
    const buf = await crypto.subtle.digest('SHA-256', data.buffer.slice(
      data.byteOffset,
